...
const Navbar = ({ showScrollButtons = false, scrollToSection }) => {
      ...
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-6">
          {showScrollButtons ? (
            ...
            <>
              <Link to="/" className="hover:text-yellow-400 transition-colors">Mint</Link>
              <Link to="/" className="hover:text-yellow-400 transition-colors">Sobre</Link>
              <Link to="/" className="hover:text-yellow-400 transition-colors">Benefícios</Link>
              <Link to="/" className="hover:text-yellow-400 transition-colors">Roadmap</Link>
              <Link to="/" className="hover:text-yellow-400 transition-colors">FAQ</Link>
            </>
          )}
          <Link to="/ranking" className="hover:text-yellow-400 transition-colors">Ranking</Link>
        </div>
